...
for (let i = 1; i < guests.length; i++)
    console.log(`Dear ${guests[i]}, i found a bigger dinner table so i invited more peoples.`);
guests.unshift("Imran");
guests.splice(3, 0, "Nadeem");
guests.push("Usman");
// Using for loop in ascending order
for (let i = 0; i < guests.length; i++)
    console.log(`Dear ${guests[i]}, You are invited in more people list to my party.`);
// Using for loop in descending order
for (let i = 6; i >= 0; i--)
    console.log(`Dear ${guests[i]} You are invited in more people list to my party.`);
// Using map
guests.map((items) => console.log(`Dear ${items} You are invited in more people list to my party.`));
